 ...
 * v0.9.0-rc1
 */
function(){"use strict";function e(e,o,a,i,d,c,l){function m(){f(),d(function(){h(),p(),u()})}function s(){function e(){var e=V.ul.getBoundingClientRect(),n={};e.right>a.right-r&&(n.left=t.right-e.width+"px"),V.$.ul.css(n)}if(!V)return d(s,0,!1);var t=V.wrap.getBoundingClientRect(),o=V.snap.getBoundingClientRect(),a=V.root.getBoundingClientRect(),i=o.bottom-a.top,c=a.bottom-o.top,l=t.left-a.left,m=t.width,u={left:l+"px",minWidth:m+"px",maxWidth:Math.max(t.right-a.left,a.right-t.left)-r+"px"};i>c&&a.height-t.bottom-r<n?(u.top="auto",u.bottom=c+"px",u.maxHeight=Math.min(n,t.top-a.top-r)+"px"):(u.top=i+"px",u.bottom="auto",u.maxHeight=Math.min(n,a.bottom-t.bottom-r)+"px"),V.$.ul.css(u),d(e,0,!1)}function u(){V.$.root.length&&(c(V.$.ul),V.$.ul.detach(),V.$.root.append(V.$.ul))}function p(){e.autofocus&&V.input.focus()}function f(){var t=parseInt(e.delay,10)||0;e.$watch("searchText",t?a.debounce(A,t):A),M(E),e.$watch("selectedItem",v),e.$watch("$mdAutocompleteCtrl.hidden",function(e,t){e&&!t&&s()}),angular.element(l).on("resize",s)}function h(){V={main:o[0],ul:o.find("ul")[0],input:o.find("input")[0],wrap:o.find("md-autocomplete-wrap")[0],root:document.body},V.snap=g(),V.$=b(V)}function g(){for(var e=o;e.length;e=e.parent())if(angular.isDefined(e.attr("md-autocomplete-snap")))return e[0];return V.wrap}function b(e){var t={};for(var n in e)t[n]=angular.element(e[n]);return t}function E(t,n){t&&(e.searchText=k(t)),e.itemChange&&t!==n&&e.itemChange(x(t))}function v(e,t){for(var n=0;n<W.length;++n)W[n](e,t)}function M(e){-1==W.indexOf(e)&&W.push(e)}function $(e){var t=W.indexOf(e);-1!=t&&W.splice(t,1)}function A(t,n){F.index=N(),(t||t!==n)&&t!==k(e.selectedItem)&&(e.selectedItem=null,e.textChange&&t!==n&&e.textChange(x(e.selectedItem)),S()?j():(F.loading=!1,F.matches=[],F.hidden=_(),R()))}function T(){Y||(F.hidden=!0)}function C(){return angular.isString(e.searchText)?(F.hidden=_(),F.hidden||j(),void 0):e.searchText=""}function w(e){switch(e.keyCode){case i.KEY_CODE.DOWN_ARROW:if(F.loading)return;e.preventDefault(),F.index=Math.min(F.index+1,F.matches.length-1),P(),L();break;case i.KEY_CODE.UP_ARROW:if(F.loading)return;e.preventDefault(),F.index=F.index<0?F.matches.length-1:Math.max(0,F.index-1),P(),L();break;case i.KEY_CODE.ENTER:if(F.hidden||F.loading||F.index<0)return;e.preventDefault(),I(F.index);break;case i.KEY_CODE.ESCAPE:F.matches=[],F.hidden=!0,F.index=N();break;case i.KEY_CODE.TAB:}}function y(){return angular.isNumber(e.minLength)?e.minLength:1}function k(t){return t&&e.itemText?e.itemText(x(t)):t}function x(e){if(e){var t={};return F.itemName&&(t[F.itemName]=e),t}}function N(){return e.autoselect?0:-1}function _(){return S()?1===F.matches.length&&e.searchText===k(F.matches[0])&&e.selectedItem===F.matches[0]:!0}function H(){return k(F.matches[F.index])}function S(){return e.searchText.length>=y()}function I(t){e.selectedItem=F.matches[t],e.searchText=k(e.selectedItem)||e.searchText,F.hidden=!0,F.index=0,F.matches=[]}function D(){e.searchText="",I(-1),V.input.focus()}function O(t){function n(n){K[o]=n,t===e.searchText&&(U=null,F.loading=!1,F.matches=n,F.hidden=_(),R(),s())}var r=e.$parent.$eval(q),o=t.toLowerCase();angular.isArray(r)?n(r):(F.loading=!0,r.success&&r.success(n),r.then&&r.then(n),r.error&&r.error(function(){F.loading=!1}))}function R(){if(!F.hidden)switch(F.matches.length){case 0:return F.messages.splice(0);case 1:return F.messages.push({display:"There is 1 match available."});default:return F.messages.push({display:"There are "+F.matches.length+" matches available."})}}function L(){F.messages.push({display:H()})}function P(){var e=t*F.index,n=e+t,r=V.ul.clientHeight;e<V.ul.scrollTop?V.ul.scrollTop=e:n>V.ul.scrollTop+r&&(V.ul.scrollTop=n-r)}function j(){var t=e.searchText,n=t.toLowerCase();U&&U.cancel&&(U.cancel(),U=null),!e.noCache&&K[n]?(F.matches=K[n],R()):O(t),F.hidden=_()}var F=this,B=e.itemsExpr.split(/ in /i),q=B[1],V=null,U=null,K={},Y=!1,W=[];return F.scope=e,F.parent=e.$parent,F.itemName=B[0],F.matches=[],F.loading=!1,F.hidden=!0,F.index=null,F.messages=[],F.id=a.nextUid(),F.keydown=w,F.blur=T,F.focus=C,F.clear=D,F.select=I,F.getCurrentDisplayValue=H,F.registerSelectedItemWatcher=M,F.unregisterSelectedItemWatcher=$,F.listEnter=function(){Y=!0},F.listLeave=function(){Y=!1},F.mouseUp=function(){V.input.focus()},m()}angular.module("material.components.autocomplete").controller("MdAutocompleteCtrl",e);var t=41,n=5.5*t,r=8;e.$inject=["$scope","$element","$mdUtil","$mdConstant","$timeout","$mdTheming","$window","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.9.0-rc1
